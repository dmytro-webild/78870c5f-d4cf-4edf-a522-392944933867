...
const primaryButton = {
  text: "Order Now & Get 15% Off Today",
  href: "/ordering"
};
...
const ProductQuantityCardsInline = () => {
      ...
      <div className="flex flex-col gap-8 md:gap-10">
        <div className="flex flex-col items-center w-content-width mx-auto gap-2">
          <div className="px-3 py-1 mb-1 text-sm card rounded w-fit">
            <p>{"Southern Kitchen Menu"}</p>
          </div>

          <TextAnimation
            text={"Fresh Cooked Comfort Plates"}
            variant={"slide-up"}
            gradientText={true}
            tag="h2"
          ...
          <TextAnimation
            text={"Hearty fried entrees, golden basket combos, homestyle sides, and sweet specialty drinks made fresh with authentic flavor."}
            variant={"slide-up"}
            gradientText={false}
            tag="p"
...
export default function ProductQuantityCardsSection() {
  return (
    <div data-webild-section="product-quantity-cards" data-section="product-quantity-cards" id="product-quantity-cards">
      <ProductQuantityCardsInline />
    </div>
  );
}
